...
Define the pure domain enums and entities for the angelina-consultoria platform. Entities MUST NOT import any infrastructure concerns (database, framework, HTTP). Each entity MUST use shared value objects where applicable and enforce its own business invariants on construction.
