...
The sidebar MUST render the logo/branding at the top, followed by navigation items for: Dashboard, Patients, Appointments, Prescriptions, Messages, and Settings. Each item MUST display an icon and a label.
